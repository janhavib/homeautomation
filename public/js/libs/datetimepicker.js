        ...
        link: function link(scope, element, attrs, ngModelController) {
          ...
          var dataFactory = {
            ...
            setTime: function setTime(unixDate) {
              ...
              var timeFormatted = newDate.getTime()/1000;
              var filteredFormat = moment.unix(timeFormatted);//.tz("America/Los_Angeles").format('ddd, DD MM YYYY HH:mm');

              var oldDate = ngModelController.$modelValue;
              ngModelController.$setViewValue(filteredFormat);
